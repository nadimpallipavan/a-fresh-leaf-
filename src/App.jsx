...
export default function App() {
  ...
  return (
    <div className="relative min-h-screen text-leaf-100 selection:bg-leaf-500 selection:text-leaf-950 font-sans">
      ...
      <section id="services" className="relative py-12 px-6 lg:py-8 lg:px-12 bg-black border-t border-leaf-900/30 lg:h-[calc(100vh-70px)] lg:min-h-[650px] flex flex-col justify-center lg:overflow-hidden">
      ...
      {/* 4. OUR WORK SECTION */}
      <section id="work" className="relative py-12 px-6 lg:py-8 lg:px-12 border-t border-leaf-900/30 lg:h-[calc(100vh-70px)] lg:min-h-[650px] flex flex-col justify-center lg:overflow-hidden">
      ...
      <section id="story" className="relative py-12 px-6 lg:py-8 lg:px-12 border-t border-leaf-900/30 lg:h-[calc(100vh-70px)] lg:min-h-[650px] flex flex-col justify-center lg:overflow-hidden">
      ...
      <section id="pricing" className="relative py-12 px-6 lg:py-8 lg:px-12 bg-black border-t border-leaf-900/30 lg:h-[calc(100vh-70px)] lg:min-h-[650px] flex flex-col justify-center lg:overflow-hidden">
        <div className="max-w-7xl mx-auto w-full">
          {/* Section Header */}
          <div className="text-center max-w-2xl mx-auto mb-4">
      ...
      <section id="contact-funnel" className="relative py-12 px-6 lg:py-16 lg:px-12 border-t border-leaf-900/30">
